/*
Compare le temps d'exécution entre loop-fusion-bad et loop-fusion-good
...
gcc -O0 compa_fusion.c -o compa_fusion.out
./compa_fusion.out 100
perf stat -e L1-dcache-load-misses,L1-dcache-loads ./compa_fusion.out 100
*/
...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < N; i++) {
        ...
        for (int j = 0; j < 4; j++) {
            ...
            snprintf(bad, sizeof(bad), "./loop-fusion-bad_%d.out", j);
            snprintf(good, sizeof(good), "./loop-fusion-good_%d.out", j);
    ...
    printf("\n");
    printf("============================================================\n");
    printf("         SYNTHÈSE DES OPTIMISATIONS DE LOOP-FUSION\n");
    printf("============================================================\n");
